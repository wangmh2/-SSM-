...
var isFirst = true;
var flashvars = {
    f: 'http://127.0.0.1:8080/newproject/video/wubai.mp4',
    c: 0,
    p: 1,
    loaded: 'loadedHandler'
};
var video = ['http://127.0.0.1:8080/video/wubai.mp4->video/mp4', 'http://www.ckplayer.com/webm/0.webm->video/webm', 'http://www.ckplayer.com/webm/0.ogv->video/ogg'];
...
function endedHandler() {
    if (videoAddress) {
        CKobject.getObjectById('ckplayer_a1').newAddress('{p->1}{f->http://127.0.0.1:8080/video/wangxiaoshu.mp4}{html5->http://127.0.0.1:8080/video/wangxiaoshu.mp4->video/mp4}')
    }
    else {
